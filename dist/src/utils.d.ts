 ...
 */
export declare function toSafeString(string: string): Capitalize<string>;
export declare function generateName(from: string, usedNames: UsedNames, schema: JSONSchema): Capitalize<string>;
