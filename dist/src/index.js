...
function compileFromFile(filename, options = exports.DEFAULT_OPTIONS) {
    ...
    return compile(schema, (0, utils_1.stripExtension)(filename), { cwd: (0, path_1.dirname)(filename), ...options });
}
...
async function compile(schema, name, options = {}) {
    ...
    const { dereferencedPaths, dereferencedSchema } = await (0, resolver_1.dereference)(_schema, _options);
    ...
    const formatted = await (0, formatter_1.format)(generated, _options);
